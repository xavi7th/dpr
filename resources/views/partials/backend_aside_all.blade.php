<aside class="main-sidebar">
	...
	<section class="sidebar">
        ...
        </a> @elseif (Auth::user()->role == 'Admin')
				<a href="/admin">
          <i class="fa fa-dashboard"></i> <span>Dashboard</span>
        </a> @elseif (Auth::user()->role == 'Staff')
				<a href="/staff">
          <i class="fa fa-dashboard"></i> <span>Dashboard</span>
        </a> @elseif (Auth::user()->role == 'Team Lead')
				<a href="/teamlead">
          <i class="fa fa-dashboard"></i> <span>Dashboard</span>
        </a> @elseif (Auth::user()->role == 'Head Gas M&G Lagos')
				<a href="/headgas">
          <i class="fa fa-dashboard"></i> <span>Dashboard</span>
        </a> @elseif (Auth::user()->role == 'ADO')
				<a href="/ado">
          <i class="fa fa-dashboard"></i> <span>Dashboard</span>
        </a> @elseif (Auth::user()->role == 'ZOPSCON')
				<a href="/zopscon">
          <i class="fa fa-dashboard"></i> <span>Dashboard</span>
        </a> @elseif (Auth::user()->role == 'Manager Gas')
				<a href="/managergas">
          <i class="fa fa-dashboard"></i> <span>Dashboard</span>
        </a> @endif
			</li>
