                ...
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    @foreach ($inbox as $item)
                      <tr>
                        @if ($item->read == 'true')
                          <td><a href="/tlDocument_review?inboxIndex={{ $item->id }}&applicationIndex={{ $item->application_id }}" class="" style="font-size: 16px; text-transform: capitalize; color: #333;">{{ $item->app_doc_review['name_of_gas_plant'] }}</a></td>
                        ...
                        @else
                          <td><a href="/tlDocument_review?inboxIndex={{ $item->id }}&applicationIndex={{ $item->application_id }}" class="" style="font-size: 16px; text-transform: capitalize; font-weight: bold; color: #333;">{{ $item->app_doc_review['name_of_gas_plant'] }}</a></td>
