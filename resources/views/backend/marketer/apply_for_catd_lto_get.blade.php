...
@section('title')
  DPR {{Auth::user()->role}} | Apply For CAT-D LTO
@endsection
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="box box-primary">
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form role="form" method="POST" action="/apply_for_catd_license_to_operate">
                {{ csrf_field() }}
                <div class="box-body">
                  ...
                  <apply-for-catd-lto-component></apply-for-catd-lto-component>
                  <!-- /.box-body -->
