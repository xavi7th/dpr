            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="small-box" id="retailer">
                        ...
                        <h3 style="margin: 0; padding: 6px; color: #fff; background-color: #282e54;">LPG/CNG Retailer
                            Outlet</h3>
                        <a href="/lpg_retailer_outlet" style="padding: 6px; text-align: left; color: #fff;"
                            class="small-box-footer">Proceed to application request <i
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="small-box" id="retailer">
                        ...
                        <h3 style="margin: 0; padding: 6px; color: #fff; background-color: #282e54;">Gas Processing
                            Facilities</h3>
                        <a href="/gas_processing_facilities_dashboard"
                            style="padding: 6px; text-align: left; color: #fff;" class="small-box-footer">Proceed to
                            application request <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="small-box" id="retailer">
                        ...
                        <a href="/gas_pipelines_dashboard" style="padding: 6px; text-align: left; color: #fff;"
                            class="small-box-footer">Proceed to application request <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="small-box" id="retailer">
                        ...
                        <h3 style="margin: 0; padding: 6px; color: #fff; background-color: #282e54;">Project Monitoring
                        </h3>
                        <a href="/project_monitoring_dashboard" style="padding: 6px; text-align: left; color: #fff;"
                            class="small-box-footer">Proceed to application request <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="small-box" id="retailer">
                        ...
                        <h3 style="margin: 0; padding: 6px; color: #fff; background-color: #282e54;">Gas Production /
                            Utilization</h3>
                        <a href="/lpg_retailer_outlet" style="padding: 6px; text-align: left; color: #fff;"
                            class="small-box-footer">Proceed to application request <i
                                class="fa fa-arrow-circle-right"></i></a>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="small-box" id="retailer">
                        ...
                        <h3 style="margin: 0; padding: 6px; color: #fff; background-color: #282e54;">Gas Sub-surface
                            Operation</h3>
                        <a href="/lpg_retailer_outlet" style="padding: 6px; text-align: left; color: #fff;"
                            class="small-box-footer">Proceed to application request <i
                                class="fa fa-arrow-circle-right"></i></a>
