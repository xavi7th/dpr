                ...
                <div class="col-md-4">
                    ...
                    <b>Capacity of tank</b> <a class="pull-right">{{ $applicationReview->capacity_of_tank }}</a>
                                ...
                                <li class="list-group-item">
                                    ...
                                    $applicationReview->application_status == 'ATC Issued')
                                    <i class="fa fa-check text-green"></i>
                                    @elseif ($applicationReview->application_status == 'Site NOT Suitable' ||
                                    $applicationReview->application_status == 'ATC Not Issued')
                    ...
                    @if ($applicationReview->sub_category == 'ATC' && $applicationReview->application_status != 'LTO Issued')
                      <form class="" action="/apply_for_lto" method="post">
                        {{ csrf_field() }}
                                ...
                                <br>
                                <a href="/apply_for_pressure_test_get" class="btn btn-primary btn-block">Apply For
                                    Pressure Test</a>
                                {{-- <form class="" action="/apply_for_lto" method="post">
                        {{ csrf_field() }}
                                <div class="form-group" id="capacity_of_tank">
                                ...
                                @else
                                @if ($licenseDetail != null && Auth::user()->role == 'Marketer')
                                @if (now()->gte($licenseDetail->expiry_date) ||
                                now()->addMonths(3)->gte($licenseDetail->expiry_date))
                        ...
                        @endif
                        @endif
                        @if ($applicationReview->sub_category == 'ATC' && $applicationReview->application_status ==
                        'ATC Issued')
                        <form class="" action="/apply_for_lto" method="post">
                            {{ csrf_field() }}
                            <div class="form-group" id="capacity_of_tank">
            ...
            <div class="col-md-8">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        $applicationReview->sub_category == 'ATC')
                        ...
                        <li class="list-group-item">
                            <span style="font-weight: 600; font-size: 16px; margin-left: 5px;">COPY OF LAST EXPIRED
                                LICENSE</span>
                            <i class="fa fa-check text-green" style="float: left;"></i>
                            <a href="/displayDocument?pic=/storage/license_docs/{{ $applicationReview->company_id }}/{{ optional($thisApplicationRenewalDetails)->comp_license_id }}/{{ optional($thisApplicationRenewalDetails)->copy_of_last_expired_license_location_url }}"
