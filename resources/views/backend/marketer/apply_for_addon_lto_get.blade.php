...
@section('title')
  DPR {{Auth::user()->role}} | Apply For ADDON LTO
@endsection
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="box box-primary">
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form role="form" method="POST" action="/apply_for_addon_license_to_operate">
                {{ csrf_field() }}
                <div class="box-body">
                  ...
                  <apply-for-addon-lto-component></apply-for-addon-lto-component>
                  <!-- /.box-body -->
