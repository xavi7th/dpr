...
<div class="content-wrapper">
    ...
    <h1 id="caps">
        Project Monitoring | milestone | edit
    </h1>
    </section>
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="" style="width: 100%;">
                                        <option selected="selected">Select</option>
                                        <option>Concept Alignments Study & Techinical Bid Evaluation Reviews</option>
                                        <option>FEED Studies</option>
                                        <option>Review of Detailed Engineering Studies/IDR</option>
                                        <option>Design/Model Reviews</option>
                                        <option>Hazop Study</option>
                                        <option>SIL/SIF</option>
                                        <option>Plant Layout Review</option>
                                        <option>Hazid, Bowtie & Fire PRAN</option>
                                        <option>Quntitative Risk Analysis & Area Classification Study</option>
                                        <option>SAFOP (FINAL)</option>
                                        <option>Critical Equipmant FAT</option>
                                        <option>Facility Pre-Comissioning Test Inspections</option>
                                        <option>Custody Transfer Metering Equipment Calibrations Tests</option>
                                        <option>Pre-start up Safety Inspections</option>
                                        <option>Management Quaterly & Monthly Project Review Meetings</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <label>Milestone Location</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-fax"></i></span>
                                        <input type="text" name="milestone_location" class="form-control" placeholder="Milestone Location">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-6">
                    ...
                    <div class="box-footer">
                        <button type="submit" class="btn btn-primary pull-right"><i class="fa fa-edit"></i> Update Record</button>
                        <button type="submit" class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete Record</button>
                    </div>
                </div>
            </div>
        </form>
