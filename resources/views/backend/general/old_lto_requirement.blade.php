...
@section('title')
  DPR {{Auth::user()->role}} | Requirement For License to Operate
@endsection
        ...
        <div class="row">
          <div class="col-md-12 col-xs-12">
            <div class="box box-primary">
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form id="site_ver_inspection_req" role="form" method="POST" action="/old_lto_req_upload" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="box-body">
