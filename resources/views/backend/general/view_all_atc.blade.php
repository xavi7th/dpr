                  ...
                  <div class="col-xs-3">
                    <div class="form-group">
                      ...
                      <div class="input-group date">
                        ...
                        <input type="text" name="from" class="form-control pull-right" id="datepicker1">
                      </div>
                      <!-- /.input group -->
                    </div>
                  </div>
                  ...
                  <tbody>
                    ...
                    {{--  {{$appDocReviewsATC}}  --}}
                      <tr>
                        ...
                        <td>{{ Carbon\Carbon::parse($item->issued_atc_licenses->date_issued)->toDayDateTimeString() }}</td>
                        <td>{{ Carbon\Carbon::parse($item->issued_atc_licenses->expiry_date)->toDayDateTimeString() }}</td>
                      </tr>
                    @endforeach
                  </tbody>
                </table>
