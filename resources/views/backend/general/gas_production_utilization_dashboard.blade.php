...
@section('title')
  DPR Access | Gas Production / Utilization
@endsection
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <hr>
        {{--  <h5 id="caps">Gas Production / Utilization</h5>  --}}
        <div class="row">
          <div class="col-md-3">
            ...
            <div class="box box-widget widget-user-2">
              ...
              <div class="widget-user-header bg-light-blue-active">
                ...
                <!-- /.widget-user-image -->
                <h3 class="widget-user-username">Upstream</h3>
          ...
          <div class="col-md-3">
            ...
            <div class="box box-widget widget-user-2">
              ...
              <div class="widget-user-header bg-light-blue-active">
                ...
                <!-- /.widget-user-image -->
                <h3 class="widget-user-username">gas plant</h3>
          ...
          <div class="col-md-3">
            ...
            <div class="box box-widget widget-user-2">
              ...
              <div class="widget-user-header bg-light-blue-active">
                ...
                <!-- /.widget-user-image -->
                <h3 class="widget-user-username">gtl plants</h3>
                <h5 class="widget-user-desc hider">Oil Pipeline License</h5>
              </div>
              <div class="box-footer no-padding">
                <ul class="nav nav-stacked">
          ...
          <div class="col-md-3">
            ...
            <div class="box box-widget widget-user-2">
              ...
              <div class="widget-user-header bg-light-blue-active">
                ...
                <!-- /.widget-user-image -->
                <h3 class="widget-user-username">lng plants</h3>
                <h5 class="widget-user-desc hider">Oil Pipeline License</h5>
              </div>
              <div class="box-footer no-padding">
                <ul class="nav nav-stacked">
          ...
          <div class="col-md-3">
            ...
            <div class="box box-widget widget-user-2">
              ...
              <div class="widget-user-header bg-light-blue-active">
                ...
                <!-- /.widget-user-image -->
                <h3 class="widget-user-username">ngc/industry pipelines</h3>
                <h5 class="widget-user-desc hider">Oil Pipeline License</h5>
              </div>
              <div class="box-footer no-padding">
                <ul class="nav nav-stacked">
          ...
          <div class="col-md-3">
            ...
            <div class="box box-widget widget-user-2">
              ...
              <div class="widget-user-header bg-light-blue-active">
                ...
                <!-- /.widget-user-image -->
                <h3 class="widget-user-username">export calculation</h3>
                <h5 class="widget-user-desc hider">Oil Pipeline License</h5>
              </div>
              <div class="box-footer no-padding">
                <ul class="nav nav-stacked">
          ...
          <div class="col-md-3">
            ...
            <div class="box box-widget widget-user-2">
              ...
              <div class="widget-user-header bg-light-blue-active">
                ...
                <!-- /.widget-user-image -->
                <h3 class="widget-user-username">total production</h3>
                <h5 class="widget-user-desc hider">Oil Pipeline License</h5>
              </div>
              <div class="box-footer no-padding">
                <ul class="nav nav-stacked">
