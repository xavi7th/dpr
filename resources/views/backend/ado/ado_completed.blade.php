                  ...
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      @foreach ($completed as $item)
                        <tr>
                          <td><a href="/ado_document_review?inboxIndex={{ $item->id }}&applicationIndex={{ $item->application_id }}" class="" style="font-size: 16px; text-transform: capitalize; font-weight: 500;">{{ $item->app_doc_review['name_of_gas_plant'] }}</a></td>
