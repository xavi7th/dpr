...
class managergasController extends Controller
{
    ...
    public function managergasOutbox()
    {
        ...
        return view('backend.managergas.managergas_outbox', compact('outbox', 'inboxUnreadCount', 'outboxCount', 'completedCount'));
    }

    public function managergasCompleted()
    {
        ...
        return view('backend.managergas.managergas_completed', compact('outboxCount', 'inboxUnreadCount', 'completedCount', 'completed'));
    }
